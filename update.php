...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary612_err) && empty($username_err)&& empty($password_err)){
        ...
        $sql = "UPDATE employees SET name=?, address=?, salary612=? , username=?, password=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssisss", $param_name, $param_address, $param_salary612, $param_username, $param_password, $param_id);
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label>salary</label>
                            <input type="text" name="salary612" class="form-control <?php echo (!empty($salary612_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $salary612; ?>">
