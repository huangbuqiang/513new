...
<html lang="en">
  ...
  <body>
    <nav class="nav">
      <div class="container">
		...
		<li ><a href="index4.html" accesskey="1" title="">Home</a></li>
          ...
          <li><a href="#" class="current"orderonline2.php" accesskey="4" title="">Order online </a></li>
          <li><a href="contactus2.html" accesskey="5" title="">Contact Us</a></li>
          <li><a href="register5.php" accesskey="6" title="">Register</a></li>
    ...
    <div class="hero3">
	  ...
	  <h31 class="h31">Please choose the goods below</h31>
...
<a id="btnEmpty" href="orderonline2.php?action=empty">Empty Cart</a>
<?php
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="orderonline2.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
				</tr>
				<?php
...
<div id="product-grid">
	...
	?>
		...
		<div class="image">
			...
			<form method="post" action="orderonline2.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
